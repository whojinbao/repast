...
<div style="margin-left:200px;">
	...
	<div class="page-container">
		<div class="text-c"> 日期范围：
			...
			<button name="" id="" class="btn btn-success" type="submit" action=""> <i class="Hui-iconfont">&#xe665;</i> 搜产品</button>
		</div>
					...
					<tr class="text-c va-m">
					   ...
					   <td class="text-l" >${menu.doTime }</td>
						...
						<td class="td-manage">
						   ...
						   <a style="text-decoration:none" class="ml-5" onClick="product_edit('产品编辑','menuAdd.jsp','10001')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> 
