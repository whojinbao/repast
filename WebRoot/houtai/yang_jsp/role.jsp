	...
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l"> <a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="role_select.action"><button type="button" class="btn btn-primary">查询</button></a>&nbsp&nbsp<button type="button" class="btn btn-primary btn-lg"
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="role_save.action" method="post">
									id:<input type="text" name="ru.role_id"><br /> <br />
									名字:<input type="text" name="ru.role_name"><br /> <br />
									描述:<input type="text" name="ru.role_info"><br /> <br />
						...
						<div class="modal-dialog modal-lg" role="document">
							<div class="modal-content" id="a1">
								<form action="role_update.action" method="post">
									...
									描述:<input type="text" name="ru.role_info"/><br>
									<input type="submit" value="提交" />
								</form>
							</div>
						</div>
