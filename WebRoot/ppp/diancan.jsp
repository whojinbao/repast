...
.shopping_add:hover,.shopping_minus:hover{ background:#ddd;}
.base{
	height:120px;
}
#shopping_cart{
	...
	<div class="row">
		...
		<div class="col-xs-9 col-sm-7 buttom">
			<div class="buttom_sort row">
				<div class="dishes_sort">热门推荐</div>
				
					<!-- 第一个菜品显示到前台界面开始边界 -->
					
					<div class="dishes_boss">
						<div class="dishes_img"><img src="../image/timg.jpg"></img></div> 	<!-- 放图片 -->
						<div class="dishes_name">油焖大虾仁</div>							<!-- 放名字 -->
						<div class="dishes_prices">￥88</div>							<!-- 放价格 -->
	...
	<div id="shopping_cart">
		<button id="shopping_cart_left">
			...
			<div id="shopping_cart_allprice">
				...
				<span class="peisongfei">配送费￥10</span>
			</div>
			<div id="allnum">
				1110
			</div>
		...
		<div id="shopping_cart_right">
			...
			<button id="shopping_cart_notnone">提交订单</button>
		</div>
	</div>
